  ...
  return (
    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <header className="mb-8 text-center">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900">Sweets & Nuts — Combo Packs</h1>
        <p className="mt-2 text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
          Curated boxes of sweets and premium nuts — perfect for gifting, festivals, or everyday treats.
        </p>
      </header>
