          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
            <div className="flex flex-col items-start space-y-6">
              ...
              <div className="flex items-center space-x-3">
                <a href="https://9nutz.com/" target="_blank" rel="noreferrer" aria-label="facebook" className="w-10 h-10 rounded-full flex items-center justify-center bg-[#4267B2] text-white shadow-sm">
                  <Facebook className="h-4 w-4" />
                </a>
                <a href="https://9nutz.com/" target="_blank" rel="noreferrer" aria-label="instagram" className="w-10 h-10 rounded-full flex items-center justify-center bg-[#111111] text_white shadow-sm">
                  <Instagram className="h-4 w-4" />
                </a>
                <a href="https://9nutz.com/" target="_blank" rel="noreferrer" aria-label="youtube" className="w-10 h-10 rounded-full flex items-center justify-center bg-[#e53935] text-white shadow-sm">
                  <Youtube className="h-4 w-4" />
                </a>
                <a href="https://9nutz.com/" target="_blank" rel="noreferrer" aria-label="linkedin" className="w-10 h-10 rounded-full flex items-center justify-center bg-[#0A66C2] text-white shadow-sm">
