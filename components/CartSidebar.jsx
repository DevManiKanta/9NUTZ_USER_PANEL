...
//   items,
//   onUpdateQuantity,
//   onProceedToPay, // kept for compatibility
//   onClearCart,
...
//   const ADDRESS_UPDATE_ENDPOINT = (id) => `${LOCAL_API_BASE}/user/address/update/${id}`; // UPDATE (edit)
...
//   const [deletingId, setDeletingId] = useState(null); // UI lock while deleting
...
//       // If the API returns JSON with a message/status, you can read it:
...
//     if (isOpen || addressModalOpen || editOpen) document.body.style.overflow = "hidden";
//     else document.body.style.overflow = "unset";
//     return () => {
//       document.body.style.overflow = prev || "unset";
//     };
//   }, [isOpen, addressModalOpen, editOpen]);
...
//                   <button
//                     onClick={handleAddAddressNavigate}
...
//               </button>
//               {addresses.length > 0 && (
//                 <button onClick={handleAddAddressNavigate} className="px-3 py-1.5 rounded bg-white border hover:bg-gray-50 text-sm">
//                   Add new
//                 </button>
//               )}
//             </div>
